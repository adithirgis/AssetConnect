      ...
      <div class="formLogIn" style="background-color:white; display: table-cell; padding:6px 12px; text-align: center; height: inherit; width: inherit;" >
         ...
         <span class="UserID"><label for ="userid" style="float:left">User ID:</label></span>  <asp:TextBox ID="txtUserID" runat="server" placeholder="Enter User ID" text-align="center" Style="float:right" class="form-control"  Height="30px"   Width="50%" margin="2px" ></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUserID" Display="Dynamic" ErrorMessage="User Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="SignIn">*</asp:RequiredFieldValidator>
          ...
          <br />
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage=" Password Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="SignIn">*</asp:RequiredFieldValidator>
                                                                      </div>
        <br /><br />
            <div class="checkbox"> 
          ...
          <br />
           <span class="psw"><a href="ForgotPass.aspx" style="text-decoration:underline; ">Forgot password?</a></span>    
        <br />
          <br />
            <div  >
