<%@ Page Language="C#" MasterPageFile="~/SiteMaster.master" AutoEventWireup="true" CodeFile="EditAssetDetails2.aspx.cs" Inherits="EditAssetDetails2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <h2 style="text-align:center">Edit Asset Masters 2</h2>
        ...
        <div class="formAssetDetails2" style="background-color:white; display: table-cell; padding:12px 18px; text-align: center; height: inherit; width:700px;" >
            ...
            <input type="reset" value="Clear" class="btn btn-default" style="float:left;"/> 
                    <asp:Button ID="btnUpdate" runat="server"  Text="Update" Height="30px"   class="btn btn-primary" OnClick="btnUpdate_Click" />
