...
public partial class LocateAsset : System.Web.UI.Page
{
    ...
    private List<AssetViewModel> GetData()
    {
        ...
        if ( DDStatus.SelectedIndex > 0 && DDCondition.SelectedIndex > 0 && DDGroup.SelectedIndex > 0)
        {
        ...
        else if (DDStatus.SelectedIndex > 0 && DDCondition.SelectedIndex > 0 && DDGroup.SelectedIndex == 0)
        {
            am1 = (from am in context.LUT_Assets_Masters
                   join grp in context.LUT_Asset_Groups on am.AGrpID equals grp.AGrpID
                   join cc in context.LUT_Current_Condition on am.CCID equals cc.CCID
        ...
        else if ( DDStatus.SelectedIndex > 0 && DDGroup.SelectedIndex > 0 && DDCondition.SelectedIndex == 0)
        {
            am1 = (from am in context.LUT_Assets_Masters
                   join grp in context.LUT_Asset_Groups on am.AGrpID equals grp.AGrpID
                   join cc in context.LUT_Current_Condition on am.CCID equals cc.CCID
        ...
        else if ( DDCondition.SelectedIndex > 0 && DDGroup.SelectedIndex > 0 && DDStatus.SelectedIndex == 0)
        {
            am1 = (from am in context.LUT_Assets_Masters
                   join grp in context.LUT_Asset_Groups on am.AGrpID equals grp.AGrpID
                   join cc in context.LUT_Current_Condition on am.CCID equals cc.CCID
