<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssetForm.aspx.cs" Inherits="AssetForm" %>
     ...
     <h2 style="text-align:center;">
      ...
      <asp:multiview ID="MV" runat="server" ActiveViewIndex="0" >
        ...
        <div class="formAssetDetails" style="background-color:white; display: table-cell; padding:12px 18px; text-align: center; height: inherit; width:50%;" >
          ...
          <br />
            <label for ="AID" style="float:left;">Asset ID</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="txtAssetCode" Display="Dynamic" ErrorMessage="Asset Code Required Field" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                <br />  <br /> 
            ...
            <br /> <br />
              ...
              <label for ="AssetGroup" style="float:left;">Asset Group</label><asp:DropDownList ID="DDAssetGroups" runat="server"  OnClientClick="return AssetG()" placeholder="Enter Asset Group" text-align="center"  class="form-control"  Height="30px" style="float:right;"  Width="50%" margin="2px">
                    </asp:DropDownList>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"  Display="Dynamic" InitialValue="0" ErrorMessage="Asset Group is Required" ForeColor="Red" ToolTip="Asset Group is Required" ControlToValidate="DDAssetGroups" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                <br /> <br />
           ...
           <label for ="DOP" style="float:left;">Date Of Purchase</label>
            ...
            <asp:ImageButton ID="imgPopup" ImageUrl="images/calenderL.png" ImageAlign="Bottom" runat="server" />
            ...
            <label for ="DOD" style="float:left;">Date of Disposal</label>
             ...
             <asp:ImageButton ID="imgPopup2" ImageUrl="images/calenderL.png" ImageAlign="Bottom" runat="server" />
            ...
            <label for ="Maintenance" style="float:left;">Maintenance</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="DDMaintenance" Display="Dynamic" ErrorMessage="Maintenance Type Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                <br /> <br />
            <label for ="Frequency" style="float:left;">Frequency of AMC or PM</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="DDFrequency" Display="Dynamic" ErrorMessage=" Frequency Required " ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                 <br /> <br />
            <label for ="PurchasePrice" style="float:left;">Purchase Price(In Rs)</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtPurchasePrice" Display="Dynamic" ErrorMessage="Purchase Price Required " ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                 <br /> <br />
           
            <label for ="LX" style="float:left;">Longitude in DD</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtLocationX" Display="Dynamic" ErrorMessage="Logitutde Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                 <br /> <br />
            <label for ="LY" style="float:left;">Latitude in DD</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtLocationY" Display="Dynamic" ErrorMessage="latitude Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                   <br /> <br />
            <label for ="CS" style="float:left;">Current Status</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="DDCurrentStatus" Display="Dynamic" ErrorMessage="Current Status Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                   <br /> <br />
            <label for ="CC" style="float:left;">Current Condition</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="DDCurrentCondition" Display="Dynamic" ErrorMessage="Current Condition Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                           <br />  <br /> 
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="DDAssetPurOrLea" Display="Dynamic" ErrorMessage="Asset Leased or Purchased Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                <br />   <br /><label for ="M" style="float:left;">Model</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator24" runat="server" ControlToValidate="txtModel" Display="Dynamic" ErrorMessage="Model Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                 ...
                 <br />   <br /><label for ="TT" style="float:left;">TagType</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="DDTagType" Display="Dynamic" ErrorMessage="Tag Type Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                <br /> <br />
            <label for ="SG" style="float:left;">Sub Group</label>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="DDSubGroup" Display="Dynamic" ErrorMessage="Asset Group Required" ForeColor="Red" ToolTip="Required Field" ValidationGroup="Save">*</asp:RequiredFieldValidator>
                <br /> <br />
           ...
           <label for ="Des" style="float:left;">Description</label>
            ...
            <%-- <input type="reset" style=" border-radius: 4px; height:37px; float:left; margin:2px" OnClick="AssetDetails.aspx" class="btn btn-default"  value="Clear"  />--%>  <%--inbuilt for reset button.--%>
              <asp:Button ID="Button1" runat="server"  Text="Next"  style="float:inherit; Height:30px;"   margin="2px" class="btn btn-default " OnClick="btnNext_Click" />      
  </div>
            </div>  
        </asp:View>
        ...
        <div class="formAssetDetails" style="background-color:white; display: table-cell; padding:12px 18px; text-align: center; height: inherit; width:50%;" >
            ...
            <br /> <br /> <br />
             <asp:Button ID="Button2" runat="server"  Text="Previous"  style="float:inherit; Height:30px;"  margin="2px" class="btn btn-default " OnClick="btnPrevious_Click" />
                          </div>
    </div>    <br /> <br /> <br />
