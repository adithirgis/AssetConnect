<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AMainMasters.aspx.cs" Inherits="AMainMasters" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>Asset Maintenance Type</title>
</head>
    <meta charset="utf-8">
...
<div class="container-fluid bg-grey text-center">
  <div class="row">
    ...
    <div class="col-sm-12">
        <h2 style="text-align:center">Asset Maintenance Type</h2>
     <div>
         <table> 
           <tr>
    ...
    <div class="auto-style3">
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="MID" DataSourceID="EntityDataSource1" InsertItemPosition="LastItem" OnItemCommand="ListView1_ItemCommand1" OnItemDataBound="ListView1_ItemDataBound1">
  ...
  <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: lightblue;color: black;">
                    ...
                    <td>
                        <asp:TextBox ID="MaintenanceTextBox" runat="server" Text='<%# Bind("Maintenance") %>' /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Required Field" Text="*" ToolTip="Required Field" ControlToValidate="MaintenanceTextBox" Display="Dynamic"></asp:RequiredFieldValidator>
                    </td>
                    <td>
            ...
            <InsertItemTemplate>
                <tr style="background-color: white">
                    ...
                    <td>
                        <asp:TextBox ID="MIDTextBox" runat="server" Text='Auto' />
                    </td>
                    <td>
                    ...
                    <td>
                     ...
                     <td>
                        <asp:Button ID="InsertButton" runat="server" CommandName="Insert" Text="Insert" Forecolor="Black"/>
            ...
            <LayoutTemplate>
                <table runat="server">
                    <tr runat="server">
                        <td runat="server">
                           <table id="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;border-collapse: collapse;border-color: black;border-style:none;border-width:0.1px;font-family: 'Times New Roman', Times, serif;">
                            <tr runat="server" style="background-color:#21618C ;color: white;">
                                                           
                                    <th runat="server">MID</th>
                                    <th runat="server">Maintenance</th>
         ...
         <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=AssetTaggingEntities" DefaultContainerName="AssetTaggingEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="LUT_Maintenance">
