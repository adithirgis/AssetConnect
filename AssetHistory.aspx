<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AssetHistory.aspx.cs" Inherits="AssetHistory" %>
...
<div class="container-fluid bg-grey text-center">
  <div class="row">
    ...
    <div class="auto-style3">
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="AHID" DataSourceID="EntityDataSource1" InsertItemPosition="LastItem">
            <AlternatingItemTemplate>
                 <tr style="background-color: lightblue;color:black;">
                          <td>
                        <asp:Label ID="AHIDLabel" runat="server" Text='<%# Eval("AHID") %>' />
                    </td>
                    <td>
                        <asp:Label ID="AIDLabel" runat="server" Text='<%# Eval("AID") %>' />
                    </td>
                    <td>
                        <asp:Label ID="HIDLabel" runat="server" Text='<%# Eval("HID") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="background-color: lightblue;color: black;">
                    ...
                    <td>
                        <asp:Label ID="AHIDLabel1" runat="server" Text='<%# Eval("AHID") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="AIDTextBox" runat="server" Text='<%# Bind("AID") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="HIDTextBox" runat="server" Text='<%# Bind("HID") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="Current_Location_XTextBox" runat="server" Text='<%# Bind("Current_Location_X") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="Current_Location_YTextBox" runat="server" Text='<%# Bind("Current_Location_Y") %>' />
                    </td>
                      <td>
            ...
            <InsertItemTemplate>
                <tr style="">
                    ...
                    <td>
                        <asp:TextBox ID="AHIDTextBox" runat="server" Text='<%# Bind("AHID") %>' />
                    </td>
                    <td>
                        <asp:TextBox ID="AIDTextBox" runat="server" Text='<%# Bind("AID") %>' />
                    </td>
                        ...
                        <td runat="server">
                          <table id="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;border-collapse: collapse;border-color: black;border-style:none;border-width:0.1px;font-family: 'Times New Roman', Times, serif;">
                            <tr runat="server" style="background-color:#21618C ;color: white;">
                                <th runat="server">AHID</th>
                                    <th runat="server">Asset ID</th>
                                    <th runat="server">History ID</th>
         ...
         <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=AssetTaggingEntities" DefaultContainerName="AssetTaggingEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="LUT_History_of_Asset">
