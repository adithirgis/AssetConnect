<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AGrpsMasters.aspx.cs" Inherits="AGrpsMasters" %>
...
<div class="container-fluid bg-grey text-center">
  <div class="row">
    ...
    <div class="col-sm-12">
        <h2 style="text-align:center">Asset Groups</h2>
     <div>
         <table> 
           <tr>
    ...
    <div class="auto-style3">
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="AGrpID" DataSourceID="EntityDataSource1" InsertItemPosition="LastItem" OnItemCommand="ListView1_ItemCommand" OnItemDataBound="ListView1_ItemDataBound">
            ...
            <EditItemTemplate>
               <tr style="background-color: lightblue;color: black;">
                    ...
                    <td>
                        <asp:TextBox ID="Asset_GroupsTextBox" runat="server" Text='<%# Bind("Asset_Groups") %>' />
                    </td>
                    <td>
            ...
            <InsertItemTemplate>
                <tr style="background-color: white">
                    ...
                    <td>
                        <asp:TextBox ID="AGrpIDTextBox" runat="server" Text='Auto' />
                    </td>
                    <td>
                        <asp:TextBox ID="Asset_GroupsTextBox" runat="server" Text='<%# Bind("Asset_Groups") %>' /><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required Field" ControlToValidate="Asset_GroupsTextBox" Display="Dynamic" ToolTip="Required Field" Text="*" ValidationGroup="InsertAG"></asp:RequiredFieldValidator>
                                    </td>
                    <td>
                        <asp:TextBox ID="DescriptionTextBox" runat="server" Text='<%# Bind("Description") %>' />
                    </td>
                     <td>
                        <asp:Button ID="InsertButton" runat="server" CommandName="Insert" Text="Insert" Forecolor="Black" ValidationGroup="InsertAG" />
            ...
            <LayoutTemplate>
                <table runat="server">
                    ...
                    <tr runat="server">
                       <td runat="server" style="text-align: center; border-width:0.1px; background-color: #85929E;font-family: 'Times New Roman', Times, serif;color: #000000;" border="1">
         ...
         <asp:EntityDataSource ID="EntityDataSource1" runat="server" ConnectionString="name=AssetTaggingEntities" DefaultContainerName="AssetTaggingEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="LUT_Asset_Groups">
